 ...
 */
  ...
  --z0mbi3-tab-font-family: "JetBrainsMono Nerd Font", serif;
  ...
  --z0mbi3-urlbar-results-url-color: #4d4168;
...
.urlbarView-row:hover > .urlbarView-row-inner {
  background-color: var(--z0mbi3-urlbar-results-url-color) !important;
}
